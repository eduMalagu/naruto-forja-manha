...
function App() {
  ...
  return (
    <>
      <h1 className={s.title}>Personagens Naruto</h1>
      <main>
        <div style={{
          ...
          <input
            ...
            placeholder='Procure um personagem (ex: Naruto)'
        ...
        <div className={s.wrapCards}>
          {data.map((item) => (
            <Card
              ...
              image={item.images?.[0]}
              name={item.name}
              species={item.personal?.classification || "Shinobi"}
            />
          ))}
        </div>
      </main>
